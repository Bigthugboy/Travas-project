...
type TravasServiceImpl struct {
	App *config.Tools
	DB  query.TravasDBRepo
}

func (tr *TravasServiceImpl) SelectTour() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		ctx.JSON(http.StatusOK, gin.H{})
	}
}

func NewTravas(app *config.Tools, db *mongo.Client) TravasService {
	return &TravasServiceImpl{
		App: app,
		DB:  repo.NewTravasDB(app, db),
	}
}

func (tr *TravasServiceImpl) ProcessRegister() gin.HandlerFunc {
	return func(ctx *gin.Context) {
...
func (tr *TravasServiceImpl) ProcessLogin() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		if err := ctx.Request.ParseForm(); err != nil {
			_ = ctx.AbortWithError(http.StatusBadRequest, gin.Error{Err: err})
		}
...
func (tr *TravasServiceImpl) BookTour() gin.HandlerFunc {
	return func(ctx *gin.Context) {
...
func (tr *TravasServiceImpl) ProcessCheckOut() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		if err := ctx.Request.ParseForm(); err != nil {
			_ = ctx.AbortWithError(http.StatusBadRequest, gin.Error{Err: err})
		}
...
func (tr *TravasServiceImpl) CreateTour() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		var tour model.Tour
		if err := ctx.Request.ParseForm(); err != nil {
			_ = ctx.AbortWithError(http.StatusBadRequest, gin.Error{Err: err})
...
func (tr *TravasServiceImpl) DeleteTour() gin.HandlerFunc {
	return func(ctx *gin.Context) {
...
func (tr *TravasServiceImpl) GetTour() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		id := ctx.Params.ByName("id")
		tourID, _ := primitive.ObjectIDFromHex(id)
...
func (tr *TravasServiceImpl) UpdateTour() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		id := ctx.Params.ByName("id")
		tourID, _ := primitive.ObjectIDFromHex(id)
		var tour = model.Tour{}
...
func (tr *TravasServiceImpl) GetAllTours() gin.HandlerFunc {
	return func(ctx *gin.Context) {
